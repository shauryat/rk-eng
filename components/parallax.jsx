...
const Iarallax = ({imageUrl}) => (
    <div>
        {/* -----basic config-----*/}
        <Parallax blur={5} bgImage={imageUrl} strength={500}>
    ...
    <Fade bottom delay={1700}>  <p className='text-white text-6xl md:text-7xl font-bold mb-4 '>RK Engineering Corporation</p>     </Fade>       
