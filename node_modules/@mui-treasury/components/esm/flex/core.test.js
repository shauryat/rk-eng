...
describe('Flex', function () {
  describe('Row', function () {
    ...
    each([['undefined', undefined, ''], ['number', 2, '16px'], ['em', '1em', '1em'], ['rem', '1rem', '1rem'], ['px', '12px', '12px']]).it('gutter support value as %s', function (unit, value, expected) {
    ...
    it('[direction: row] children has correct gutter', function () {
      render( /*#__PURE__*/React.createElement(Row, {
        gutter: 2
      }, /*#__PURE__*/React.createElement(Item, null, "item1"), /*#__PURE__*/React.createElement(Item, null, "item2"), /*#__PURE__*/React.createElement(Item, null, "item3")));
  ...
  describe('Nested', function () {
    it('NestedRow,Column has correct style', function () {
      ...
      expect(screen.getByText('nested-row item2')).toHaveStyle('padding-left: 16px');
      ...
      expect(screen.getByText('nested-column item2')).toHaveStyle('padding-top: 16px');
      expect(screen.getByText('nested-column item3')).toHaveStyle('padding-top: 16px');
    });
  });
