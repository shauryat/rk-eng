...
var getStretchLength = function getStretchLength(_ref) {
  var _ref$personHeight = _ref.personHeight,
      ...
      length = _ref$length === void 0 ? DEFAULT_VAR.length : _ref$length;
  return personHeight + 3 * length;
};

export default (function (_ref2) {
  var palette = _ref2.palette;
  return _extends(_extends({}, treeChartStyles()), {}, {
    spouse: {
      display: 'inline-flex',
      position: 'relative',
      marginLeft: function marginLeft(_ref3) {
        var _ref3$gutter = _ref3.gutter,
            gutter = _ref3$gutter === void 0 ? DEFAULT_VAR.gutter : _ref3$gutter;
        return gutter * 2;
      },
      '&:before': {
        content: '""',
        ...
        width: function width(_ref4) {
          var _ref4$gutter = _ref4.gutter,
              gutter = _ref4$gutter === void 0 ? DEFAULT_VAR.gutter : _ref4$gutter;
          return gutter * 2;
        },
        ...
        left: function left(_ref5) {
          var _ref5$gutter = _ref5.gutter,
              gutter = _ref5$gutter === void 0 ? DEFAULT_VAR.gutter : _ref5$gutter;
          return -gutter * 2;
        }
      }
    },
      ...
      '&:after': {
        ...
        outline: function outline(_ref6) {
          var _ref6$outline = _ref6.outline,
              _outline = _ref6$outline === void 0 ? DEFAULT_VAR.outline : _ref6$outline;
        ...
        left: function left(_ref7) {
          var _ref7$gutter = _ref7.gutter,
              gutter = _ref7$gutter === void 0 ? DEFAULT_VAR.gutter : _ref7$gutter;
          return -gutter;
        }
      }
    },
      ...
      '&:first-child:before': {
        left: function left(_ref8) {
          var _ref8$avatarSize = _ref8.avatarSize,
              ...
              gutter = _ref8$gutter === void 0 ? DEFAULT_VAR.gutter : _ref8$gutter;
      ...
      '&:last-child:not(:first-child):before': {
        right: function right(_ref9) {
          var _ref9$avatarSize = _ref9.avatarSize,
              ...
              gutter = _ref9$gutter === void 0 ? DEFAULT_VAR.gutter : _ref9$gutter;
          return "calc(50% + ".concat(avatarSize / 2, "px + ").concat(gutter, "px)");
        }
      }
    },
