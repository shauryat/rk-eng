    ...
    spouse: {
      ...
      marginLeft: function marginLeft(_ref3) {
        var _ref3$gutter = _ref3.gutter,
            gutter = _ref3$gutter === void 0 ? _tree.DEFAULT_VAR.gutter : _ref3$gutter;
        return gutter * 2;
      },
      '&:before': {
        content: '""',
        ...
        width: function width(_ref4) {
          var _ref4$gutter = _ref4.gutter,
              gutter = _ref4$gutter === void 0 ? _tree.DEFAULT_VAR.gutter : _ref4$gutter;
          return gutter * 2;
        },
        ...
        left: function left(_ref5) {
          var _ref5$gutter = _ref5.gutter,
              gutter = _ref5$gutter === void 0 ? _tree.DEFAULT_VAR.gutter : _ref5$gutter;
          return -gutter * 2;
        }
      }
    },
      ...
      '&:after': {
        ...
        left: function left(_ref7) {
          var _ref7$gutter = _ref7.gutter,
              gutter = _ref7$gutter === void 0 ? _tree.DEFAULT_VAR.gutter : _ref7$gutter;
          return -gutter;
        }
      }
    },
      ...
      '&:first-child:before': {
        left: function left(_ref8) {
          var _ref8$avatarSize = _ref8.avatarSize,
              ...
              gutter = _ref8$gutter === void 0 ? _tree.DEFAULT_VAR.gutter : _ref8$gutter;
      ...
      '&:last-child:not(:first-child):before': {
        right: function right(_ref9) {
          var _ref9$avatarSize = _ref9.avatarSize,
              ...
              gutter = _ref9$gutter === void 0 ? _tree.DEFAULT_VAR.gutter : _ref9$gutter;
          return "calc(50% + ".concat(avatarSize / 2, "px + ").concat(gutter, "px)");
        }
      }
    },
