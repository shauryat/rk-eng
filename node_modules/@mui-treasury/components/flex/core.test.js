...
describe('Flex', function () {
  describe('Row', function () {
    ...
    (0, _jestEach["default"])([['undefined', undefined, ''], ['number', 2, '16px'], ['em', '1em', '1em'], ['rem', '1rem', '1rem'], ['px', '12px', '12px']]).it('gutter support value as %s', function (unit, value, expected) {
    ...
    it('[direction: row] children has correct gutter', function () {
      (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_Row["default"], {
        gutter: 2
      }, /*#__PURE__*/_react["default"].createElement(_Item["default"], null, "item1"), /*#__PURE__*/_react["default"].createElement(_Item["default"], null, "item2"), /*#__PURE__*/_react["default"].createElement(_Item["default"], null, "item3")));
      expect(_react2.screen.getByText(/item1/)).toHaveStyle('');
      expect(_react2.screen.getByText(/item2/)).toHaveStyle('padding-left: 16px');
      expect(_react2.screen.getByText(/item3/)).toHaveStyle('padding-left: 16px');
    });
  });
  describe('Column', function () {
    ...
    it('[direction: row] children has correct gutter', function () {
      ...
      expect(_react2.screen.getByText(/item1/)).toHaveStyle('');
      expect(_react2.screen.getByText(/item2/)).toHaveStyle('padding-top: 16px');
      expect(_react2.screen.getByText(/item3/)).toHaveStyle('padding-top: 16px');
    });
  });
  ...
  describe('Nested', function () {
    it('NestedRow,Column has correct style', function () {
      (0, _react2.render)( /*#__PURE__*/_react["default"].createElement(_Row["default"], {
        "data-testid": 'row',
        gutter: 2
      ...
      expect(_react2.screen.getByTestId('nested-row')).toHaveStyle("padding-left: 16px");
      expect(_react2.screen.getByText('nested-row item1')).toHaveStyle('');
      expect(_react2.screen.getByText('nested-row item2')).toHaveStyle('padding-left: 16px');
      expect(_react2.screen.getByTestId('nested-column')).toHaveStyle('padding-left: 16px');
      expect(_react2.screen.getByText('nested-column item1')).toHaveStyle('');
      expect(_react2.screen.getByText('nested-column item2')).toHaveStyle('padding-top: 16px');
      expect(_react2.screen.getByText('nested-column item3')).toHaveStyle('padding-top: 16px');
    });
  });
  describe('Real world', function () {
    ...
    it("Showcase direction:column should have correct style", function () {
      ...
      expect(_react2.screen.getByTestId('basicProfile-row')).toHaveStyle('padding-top: 16px');
    ...
    it("Showcase direction:row should have correct style", function () {
      ...
      expect(_react2.screen.getByTestId('column-wrapper')).toHaveStyle('padding-left: 16px');
      expect(_react2.screen.getByTestId('cardHeader-row')).not.toHaveStyle('padding: 16px');
      expect(_react2.screen.getByTestId('cardHeader-info')).toHaveStyle('align-self: center');
      expect(_react2.screen.getByTestId('cardHeader-iconBtn')).toHaveStyle('margin-left: auto; margin-right: -4px');
      expect(_react2.screen.getByTestId('basicProfile-row')).toHaveStyle('margin-top: auto; padding-top: 16px');
      expect(_react2.screen.getByTestId('basicProfile-item')).toHaveStyle('align-self: center; padding-left: 8px');
    });
  });
});